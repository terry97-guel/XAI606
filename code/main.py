...
from configs.template import PRIMNET_ARGS_TEMPLATE, FC_PRIMNET_ARGS_TEMPLATE
...
# %%
def main(args:Union[PRIMNET_ARGS_TEMPLATE, FC_PRIMNET_ARGS_TEMPLATE]):
    ### SEED ###
    set_seed(args.seed)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--configs", default="PCC_PRIMNET/ELASTICA.py",type=str) # [FC_PRIMNET, PCC_PRIMNET, PRIMNET_FULL] # [FINGER, ABAQUS_32, ELASTICA]
